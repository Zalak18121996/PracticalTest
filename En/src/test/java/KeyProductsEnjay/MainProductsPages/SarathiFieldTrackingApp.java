...
public class SarathiFieldTrackingApp {
    private WebDriver driver;
    private Actions actions;

    // Locators for the product links
    private By productsMenu = By.xpath("//a[@class='mega-menu-link' and text()='Products']");
    private By SarathiFieldTrackingAppLink = By.linkText("Sarathi Field Tracking");

    // Example locator for an element unique to the Sangam CRM page
    private By pageHeader = By.xpath("//h1[contains(text(),'Sarathi Field Tracking')]"); // Adjust as necessary

    // Constructor
    public SarathiFieldTrackingApp(WebDriver driver) {
        this.driver = driver;
        this.actions = new Actions(driver); // Initialize Actions
    }

    // Method to hover over the Products menu and click on Sangam CRM
    public void hoverAndClickSarathiFieldTrackingApp() {
        ...
        driver.findElement(SarathiFieldTrackingAppLink).click();
    }
